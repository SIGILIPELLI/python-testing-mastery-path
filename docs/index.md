---
title: "Learn Python Software Testing Free: Manual QA + Automation"
description: "Free software testing course using Python -- 40 hands-on lessons covering manual QA, test case design, pytest, Selenium and CI automation, with 4 real projects. Part of a free learning library."
---
...
A structured, module-wise software testing program that takes you from your first
test case to a production-grade automation framework — covering **both manual
testing fundamentals and Python test automation**, with runnable code and
real-world templates in every module and a hands-on project at the end of each
level.
...
- **Manual testers** who want to add Python automation without skipping the QA fundamentals.
- **Developers** who need to write and maintain real test suites, not just a few asserts.
- **Career changers** starting QA from zero — Level 1 assumes no testing and no Python experience.

## How to use this site

- Work through each level in order — later modules assume earlier ones.
- Manual-testing modules give you templates and worked examples you can reuse on
  a real project; automation modules give you runnable code — copy them into a
  local `.py` file and run them.
